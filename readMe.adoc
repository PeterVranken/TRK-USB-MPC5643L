...
This branch has been made to do the first development of a multi-core
RTOS. Meanwhile, the RTOS is running on several multi-core derivatives of
the MPC family but it has never been tested in dual core mode (DPM) of the
MPC5643L. Although the RTOS is running on the MPC5643L in lockstep mode
(LSM), it has simply no advantage to use the multi-core in this
configuration. Therefore, the code found in this development branch is not
of any practical use and maybe, we will even delete this branch in the
future.

== The samples

The most prominent embedded sample is the blinking LED, called
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-multiInstance/LSM/startup["startup"]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-multiInstance/LSM/printf["printf"]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-multiInstance/LSM/ADC["ADC"]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-multiInstance/LSM/RTOS["RTOS"]
...
image:LSM/safe-RTOS-VLE/doc/manual/theme/iconSafeRTOS-asColoredIcon.jpg[width="3%",
pdfwidth="5%"]
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-multiInstance/LSM/safe-RTOS-VLE["safe-RTOS"]
...
implements the _freedom-from-interference_ paradigm. In this branch,
safe-RTOS has been extended for multi-core use. This has not been tested
with both cores of the MPC5643L in DPM but was the basis for the migration
of safe-RTOS for
https://github.com/PeterVranken/DEVKIT-MPC5748G/tree/master/samples/safe-RTOS[MPC5748G^]
(three cores) and MPC5775B/E (dual core). It's not recommended to use this
code.

https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-multiInstance/LSM/kernelBuilder["kernelBuilder"]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-multiInstance/LSM/RTuinOS["RTuinOS"]
...
* Most relevant documentation about the evaluation board and the
  ...
  https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-multiInstance/doc[doc]
