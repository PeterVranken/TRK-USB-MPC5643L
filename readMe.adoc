...
revisions or ports of GCC or other derivates from the microcontroller
...
clean piece of startup code -- either in Book E or VLE instruction set
--, which will suffice for most applications. Remove the LED blink code
and start writing your application but don't loose time with setting up
...
functionality similar to an OSEK/VDX kernel of conformance class BCC1 or
BCC2.
...
microcontroller has been collected in folder `doc` and much, much more can
