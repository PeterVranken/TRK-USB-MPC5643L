...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/startup["startup"]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/printf["printf"]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/ADC["ADC"]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/RTOS["RTOS"]
...
pdfwidth="5%"]
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/safe-RTOS-VLE["safe-RTOS"]
...
implements the _freedom-from-interference_ paradigm. In this branch, it
makes use of the hardware scheduler in the MCU. This concept limits the
number of tasks but means a small performance advantage in comparison to
the conventional scheduler offered in the master branch.

https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/kernelBuilder["kernelBuilder"]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/RTuinOS["RTuinOS"]
...
* Most relevant documentation about the evaluation board and the
  ...
  https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/doc[doc]
