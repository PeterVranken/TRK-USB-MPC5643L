...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-swScheduler/LSM/startup["startup"]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-swScheduler/LSM/printf["printf"]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-swScheduler/LSM/ADC["ADC"]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-swScheduler/LSM/RTOS["RTOS"]
...
image:LSM/safe-RTOS-VLE/doc/manual/theme/iconSafeRTOS-asColoredIcon.jpg[width="3%", pdfwidth="5%"] https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-swScheduler/LSM/safe-RTOS-VLE["safe-RTOS"]
...
TIP: On this branch, safe-RTOS-VLE is available with a new software
scheduler. An unlimited number of events and tasks can be created but the
CPU load is a bit higher.

https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-swScheduler/LSM/kernelBuilder["kernelBuilder"]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-swScheduler/LSM/RTuinOS["RTuinOS"]
...
* Most relevant documentation about the evaluation board and the
  ...
  https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-swScheduler/doc[doc]
