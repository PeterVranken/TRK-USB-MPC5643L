...
to produce the flashable files (`bin\ppc\DEBUG\TRK-USB-MPC5643L-startup.elf`
and `bin\ppc\PRODUCTION\TRK-USB-MPC5643L-startup.elf`).
...
icon "bug", then click "Debug Configurations.../CodeWarrior/Debug startup
