...
#
#   cwide.exe -data "c:\tmp\wsp_StandaloneFlsh" -vmargsplus -Dcw.script=(...)\TRK-USB-MPC5643L\LSM\startup\makefile\debugger\flashPRODUCTION.tcl
#
...
fl::target -lc "Debug startup (PRODUCTION)"
...
# offset settings off.
cmdwin::fl::image -f ..\\..\\bin\\ppc\\PRODUCTION\\TRK-USB-MPC5643L-startup.elf -t "Auto Detect" -re on -r 0x0 0xfffff -oe off
