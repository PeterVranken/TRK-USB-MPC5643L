...
(https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/RTOS[Ref.
...
| Ref. 1
  | https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/RTOS
  | Simple RTOS
|=======
...
Sorry, this section is still missing.
 ...
 ** Trick: Have a regular 100us timer interrupt with empty ISR. Now we
    have a resume and check every 100us
* Not working if there's no preempting ISR. Function can't be guaranteed
  for prio equal or above kernel prio
* Exception leaves tasks and data in inconsistent state. (Can abort task
  in the middle of a critical section.) Generally no reasonable means to
  limit execution time. Just an error recognition and worst case hindering
  tool
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/RTOS-VLE#The-RTOS[readme^]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/safe-RTOS-VLE/code/system/drivers/ledAndButton[ledAndButton^]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/safe-RTOS-VLE/code/system/drivers/ledAndButton[ledAndButton^]
and
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/safe-RTOS-VLE/code/system/drivers/serial[serialIO^]
...
files in folder
https://github.com/PeterVranken/TRK-USB-MPC5643L/blob/safe-RTOS-hwScheduler/LSM/safe-RTOS-VLE/code/system/RTOS[code/system/RTOS^]
and particularly in the main header file,
https://github.com/PeterVranken/TRK-USB-MPC5643L/blob/safe-RTOS-hwScheduler/LSM/safe-RTOS-VLE/code/system/RTOS/rtos.h[code/system/RTOS/rtos.h^]. Furthermore, there is the Doxygen API reference at
https://htmlpreview.github.io/?https://raw.githubusercontent.com/PeterVranken/TRK-USB-MPC5643L/safe-RTOS-hwScheduler/LSM/safe-RTOS-VLE/doc/doxygen/html/globals_func.html[doc/doxygen/html^].
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/blob/safe-RTOS-hwScheduler/LSM/safe-RTOS-VLE/code/system/RTOS/rtos.h[`rtos.h`^]
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/blob/safe-RTOS-hwScheduler/LSM/safe-RTOS-VLE/code/system/RTOS/rtos_systemMemoryProtectionUnit.c[rtos_systemMemoryProtectionUnit.c^]),
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/blob/safe-RTOS-hwScheduler/LSM/safe-RTOS-VLE/code/system/startup/typ_types.h[typ_types.h^],
