...
if {[info exists APP]  &&  $APP!=""} {
    ...
    fl::target -lc "safe-RTOS-VLE ($APP, PRODUCTION)"
    ...
    cmdwin::fl::image -f ..\\..\\bin\\ppc\\$APP\\PRODUCTION\\TRK-USB-MPC5643L-safe-RTOS-VLE.elf -t "Auto Detect" -re on -r 0x0 0xfffff -oe off
    ...
    puts "safe-RTOS-VLE application $APP has been flashed in PRODUCTION compilation"
