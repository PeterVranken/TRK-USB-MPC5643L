...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-multiInstance/LSM/RTuinOS/doc/manual/RTuinOS-1.0-UserGuide.pdf[PDF manual].
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/blob/safe-RTOS-multiInstance/LSM/kernelBuilder/readMe.adoc[LSM/kernelBuilder/readMe.adoc]
for details.
