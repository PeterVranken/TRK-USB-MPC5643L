...
if {$APP != ""} {
    ...
    fl::target -lc "RTuinOS $APP (DEBUG)"
    ...
    cmdwin::fl::image -f ..\\..\\bin\\ppc\\$APP\\DEBUG\\TRK-USB-MPC5643L-RTuinOS-$APP.elf -t "Auto Detect" -re on -r 0x0 0xfffff -oe off
    ...
    puts "RTuinOS has been flashed with application $APP in DEBUG compilation"
