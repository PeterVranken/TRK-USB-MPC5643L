...
#define RTOS_ISR_USER_00    59 /* PIT 0 */
...
#define RTOS_ISR_USER_00_ACKNOWLEDGE_IRQ \
            {assert(PIT.TFLG0.B.TIF == 0x1); PIT.TFLG0.B.TIF = 0x1;}
...
#define RTOS_ISR_USER_01    60 /* PIT 1 */
...
#define RTOS_ISR_USER_01_ACKNOWLEDGE_IRQ \
            {assert(PIT.TFLG1.B.TIF == 0x1); PIT.TFLG1.B.TIF = 0x1;}
