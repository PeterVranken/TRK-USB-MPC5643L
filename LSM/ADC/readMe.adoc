...
https://github.com/PeterVranken/TRK-USB-MPC5643L/blob/safe-RTOS-hwScheduler/LSM/ADC/code/ADC/adc_eTimerClockedAdc.h[`adc_eTimerClockedAdc.h`]
and
https://github.com/PeterVranken/TRK-USB-MPC5643L/blob/safe-RTOS-hwScheduler/LSM/ADC/code/ADC/adc_eTimerClockedAdc.c[`adc_eTimerClockedAdc.c`]
for details.
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/blob/safe-RTOS-hwScheduler/LSM/ADC/code/ADC/adc_eTimerClockedAdc.c[source
code] comments.
...
https://github.com/PeterVranken/TRK-USB-MPC5643L/tree/safe-RTOS-hwScheduler/LSM/startup#api
