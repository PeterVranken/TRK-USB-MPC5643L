...
#
#   cwide.exe -data "c:\tmp\wsp_StandaloneFlsh" -vmargsplus -Dcw.script=(...)\TRK-USB-MPC5643L\LSM\ADC\makefile\debugger\flashDEBUG.tcl
#
...
# offset settings off.
cmdwin::fl::image -f ..\\..\\bin\\ppc\\DEBUG\\TRK-USB-MPC5643L-ADC.elf -t "Auto Detect" -re on -r 0x0 0xfffff -oe off
