...
#
#   cd ../LSM/ADC/makefile/debugger (depending on where you are)
#   pwd
#   dir
...
#
#   cwide.exe -data "c:\tmp\wsp_StandaloneFlsh" -vmargsplus -Dcw.script=(...)\TRK-USB-MPC5643L\LSM\ADC\makefile\debugger\flashPRODUCTION.tcl
#
...
fl::target -lc "Debug ADC (PRODUCTION)"
...
# offset settings off.
cmdwin::fl::image -f ..\\..\\bin\\ppc\\PRODUCTION\\TRK-USB-MPC5643L-ADC.elf -t "Auto Detect" -re on -r 0x0 0xfffff -oe off
