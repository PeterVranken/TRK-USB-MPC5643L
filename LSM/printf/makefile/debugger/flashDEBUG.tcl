...
#
#   cwide.exe -data "c:\tmp\wsp_StandaloneFlsh" -vmargsplus -Dcw.script=TRK-USB-MPC5643LAtGitHub\LSM\printf\makefile\debugger\flashDEBUG.tcl
#
...
fl::target -lc "Debug printf (DEBUG)"
...
# offset settings off.
cmdwin::fl::image -f ..\\..\\bin\\ppc\\DEBUG\\TRK-USB-MPC5643L-printf.elf -t "Auto Detect" -re on -r 0x0 0xfffff -oe off
