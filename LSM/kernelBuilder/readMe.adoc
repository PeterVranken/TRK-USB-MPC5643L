...
* Return zero to not switch context, to continue the preempted context
  like an ordinary ISR always does. `*pCmdCtxtSw` doesn't care
...
include::code/samples/simpleSampleFromReadme/rms_readmeSample.c[]
