     ...
     *
     * Note, the indentation of all lines in this file has been chosen to become able to
     * use without any change as quoted text inside the Asciidoc readme of kernelBuilder.
     * 
    ...
    unsigned int rms_cntOverrunTask100ms = 0;
    ...
    static void enableRTOSSystemTimer(void)
    {
        ...
        PIT.LDVAL0.R = 12000000-1; /* Interrupt rate 1ms */
    ...
    /**
     * The implementation of our system call to terminate the task (and to keep the context
     ...
     *   @param taskParam Data provided at creation of task context. Here: No lost
     * activations.
     */
