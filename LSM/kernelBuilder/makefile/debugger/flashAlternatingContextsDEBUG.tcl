...
#
#   cwide.exe -data "c:\tmp\wsp_StandaloneFlsh" -vmargsplus -Dcw.script=(...)\TRK-USB-MPC5643L\LSM\kernelBuilder\makefile\debugger\flashAlternatingContextsDEBUG.tcl
#
...
fl::target -lc "kernelBuilder (alternatingContexts, Book E, DEBUG)"
...
# offset settings off.
cmdwin::fl::image -f ..\\..\\bin\\ppc-BookE\\alternatingContexts\\DEBUG\\TRK-USB-MPC5643L-kernelBuilder.elf -t "Auto Detect" -re on -r 0x0 0xfffff -oe off
