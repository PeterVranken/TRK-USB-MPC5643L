...
#   pwd
#   dir
#   source flashChainedContextCreationDEBUG.tcl
#
#   According to
...
#
#   cwide.exe -data "c:\tmp\wsp_StandaloneFlsh" -vmargsplus -Dcw.script=(...)\TRK-USB-MPC5643L\LSM\kernelBuilder\makefile\debugger\flashChainedContextCreationDEBUG.tcl
#
...
# offset settings off.
cmdwin::fl::image -f ..\\..\\bin\\ppc\\DEBUG\\chainedContextCreation\\TRK-USB-MPC5643L-kernelBuilder.elf -t "Auto Detect" -re on -r 0x0 0xfffff -oe off
