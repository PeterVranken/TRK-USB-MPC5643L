...
fl::target -lc "kernelBuilder (alternatingContexts, PRODUCTION)"
...
# offset settings off.
cmdwin::fl::image -f ..\\..\\bin\\ppc\\alternatingContexts\\PRODUCTION\\TRK-USB-MPC5643L-kernelBuilder.elf -t "Auto Detect" -re on -r 0x0 0xfffff -oe off
