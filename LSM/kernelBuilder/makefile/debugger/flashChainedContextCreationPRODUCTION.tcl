...
#   pwd
#   dir
#   source flashChainedContextCreationPRODUCTION.tcl
#
#   According to
...
#
#   cwide.exe -data "c:\tmp\wsp_StandaloneFlsh" -vmargsplus -Dcw.script=(...)\TRK-USB-MPC5643L\LSM\kernelBuilder\makefile\debugger\flashChainedContextCreationPRODUCTION.tcl
#
...
fl::target -lc "kernelBuilder (chainedContextCreation, Book E, PRODUCTION)"
...
# offset settings off.
cmdwin::fl::image -f ..\\..\\bin\\ppc-BookE\\chainedContextCreation\\PRODUCTION\\TRK-USB-MPC5643L-kernelBuilder.elf -t "Auto Detect" -re on -r 0x0 0xfffff -oe off
