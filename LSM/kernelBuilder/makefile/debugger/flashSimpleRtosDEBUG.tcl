...
fl::target -lc "kernelBuilder (simpleRTOS, DEBUG)"
...
# offset settings off.
cmdwin::fl::image -f ..\\..\\bin\\ppc\\simpleRTOS\\DEBUG\\TRK-USB-MPC5643L-kernelBuilder.elf -t "Auto Detect" -re on -r 0x0 0xfffff -oe off
