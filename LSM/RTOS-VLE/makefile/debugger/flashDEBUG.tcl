...
#
#   cwide.exe -data "c:\tmp\wsp_StandaloneFlsh" -vmargsplus -Dcw.script=(...)\TRK-USB-MPC5643L\LSM\RTOS-VLE\makefile\debugger\flashDEBUG.tcl
#
...
fl::target -lc "Debug RTOS-VLE (DEBUG)"
...
# offset settings off.
cmdwin::fl::image -f ..\\..\\bin\\ppc\\DEBUG\\TRK-USB-MPC5643L-RTOS-VLE.elf -t "Auto Detect" -re on -r 0x0 0xfffff -oe off
